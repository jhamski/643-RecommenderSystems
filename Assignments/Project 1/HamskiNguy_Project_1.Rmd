...
```{r define_artists}
artist_1 <- '50 Cent'
artist_2 <- 'Nine Inch Nails'
```

```{r reclab_recommendations_1}
#Old-school hiphop band A Tribe Called Quest's similar listens
ATribeCalledQuest.sim.row <- reclab.sim.item.matrix[artist_1,]
...
sort(ATribeCalledQuest.similar.listens, decreasing = TRUE)[1:10]
```

```{r artist_recommendations_2}
#Old-school hiphop band A Tribe Called Quest's similar listens
ATribeCalledQuest.sim.row <- reclab.sim.item.matrix[artist_2,]
...
recommendation.custom <- custom.similarity.item[artist_1,]
...
recommendation.custom <- recommendation.custom[recommendation.custom<1]

sort(recommendation.custom, decreasing = TRUE)[1:10]
```

```{r custom_artist_recommendations_2}
recommendation.custom <- custom.similarity.item[artist_2,]
recommendation.custom <- as.matrix(t(recommendation.custom))
