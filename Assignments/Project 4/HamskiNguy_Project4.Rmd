...
```{r}
user.artists.train.ave <- user.artists.ave[which.train, ]
user.artist.test.ave <- user.artists.ave[!which.train, ]
```
...
user.artists.rrm.test <- new("realRatingMatrix", data = as(user.artist.test, "Matrix"))
